...
class BaseLearner(object):
    def __init__(self, args):
        ...
        jt.flags.use_cuda = 1 if self._device.startswith('cuda') else 0
    ...
    def save_checkpoint(self, filename):
        ...
        self._network.save(save_dict, '{}_{}.pkl'.format(filename, self._cur_task))
    ...
    def _compute_accuracy(self, model, loader):
        ...
        for i, (_, inputs, targets) in enumerate(loader):
            ...
            predicts = outputs.argmax(dim=1)[0]
    ...
    def _eval_cnn(self, loader):
        ...
        for _, (_, inputs, targets) in enumerate(loader):
            ...
            values, indices = jt.topk(outputs, k=self.topk, dim=1, largest=True, sorted=True)
            y_pred.append(indices.numpy())
    ...
    def _extract_vectors(self, loader):
        ...
        for _, _inputs, _targets in loader:
            ...
            _inputs=jt.array(_inputs)
            _vectors=self._network.extract_vector(_inputs).numpy()
